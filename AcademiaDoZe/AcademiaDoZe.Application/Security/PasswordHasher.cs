...
/// <summary>
/// Hash de senha com Argon2id (Konscious).
/// Formato de armazenamento: ARGON2ID:{t}:{mKb}:{p}:{saltBase64}:{hashBase64}
///
/// É esta classe, e não o Value Object Senha, que produz o valor que vai para o banco.
/// Senha.Criar continua sendo usado antes, para validar a força do texto digitado; o que é
/// persistido é o retorno de Hash(). Sem isso a coluna senha guardaria o texto puro, já que
/// os repositórios gravam Senha.TextoPlano.
/// </summary>
