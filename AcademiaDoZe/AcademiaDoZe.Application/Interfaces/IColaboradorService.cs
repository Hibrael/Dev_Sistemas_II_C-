...
public interface IColaboradorService
{
    ...
    /// <summary>Verifica se já existe um colaborador com o CPF informado.</summary>
    Task<bool> CpfJaExisteAsync(string cpf, int? id = null, CancellationToken cancellationToken = default);

    /// <summary>Verifica se já existe um colaborador com o email informado.</summary>
    Task<bool> EmailJaExisteAsync(string email, int? id = null, CancellationToken cancellationToken = default);

    /// <summary>Realiza a troca de senha do colaborador, gerando um novo hash pelo Value Object Senha.</summary>
