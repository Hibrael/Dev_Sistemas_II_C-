...
namespace AcademiaDoZe.Infrastructure.Data
{
    public static class DataReaderExtensions
    {
        ...
        public static string GetNullableString(this DbDataReader reader, string columnName, string defaultValue = "") => reader[columnName] is DBNull ? defaultValue : reader[columnName].ToString()!;
        public static byte[]? GetNullableBytes(this DbDataReader reader, string columnName) => reader[columnName] is DBNull ? null : (byte[])reader[columnName];
